function loadlab() {
    ...
    let column_4 = [64,60,83,84,57,52,76,85,81,65,90,67,42,85,87,96,51,100,40,75,44,92,61,91,68,44,79,68,45,43];
    ...
    const results = {
        col1: [2,4,5,5,3,2,4,1,9,4,3,3,5,8,4,9,10,1,8,3,3,2,8,3,10,4,7,1,5,1],	
        col2: [3,3,5,1,7,2,6,3,4,9,5,4,6,2,2,1,3,9,5,7,10,7,5,5,8,7,8,9,2,5],   	
